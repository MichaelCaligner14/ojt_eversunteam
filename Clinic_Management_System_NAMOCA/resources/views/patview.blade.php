...
<button class="mobile-menu-button p-4 focus:outline-none focus:bg-gray-500">
    ...
    <tbody>
        ...
        <tr class="bg-gray-800 lg:hover:bg-gray-700  flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
            ...
            <td class="w-full lg:w-auto p-3  text-white text-center border border-b text-center block lg:table-cell relative lg:static">
                <span class="lg:hidden absolute top-0 left-0 bg-gray-800 px-2 py-1 text-xs font-bold uppercase">Email Address</span>
                {{$item ->email}}
            </td>
            <td class="w-full lg:w-auto p-3  text-white text-center border border-b text-center block lg:table-cell relative lg:static">
                <span class="lg:hidden absolute top-0 left-0 bg-gray-800 px-2 py-1 text-xs font-bold uppercase">Contact</span>
                {{$item ->contact}}
            </td>
            <td class="w-full lg:w-auto p-3  text-white text-center border border-b text-center block lg:table-cell relative lg:static">
                <span class="lg:hidden absolute top-0 left-0 bg-gray-800 px-2 py-1 text-xs font-bold uppercase">Age</span>
                {{$item ->age}}
            </td>
            ...
            <td class="w-full lg:w-auto p-3  text-white text-center border border-b text-center block lg:table-cell relative lg:static">
                <span class="lg:hidden absolute top-0 left-0 bg-gray-800 px-2 py-1 text-xs font-bold uppercase">Temperature</span>
                {{$item ->temp}}
                
            </td>

            <td class="w-full lg:w-auto p-3  text-white text-center border border-b text-center block lg:table-cell relative lg:static">
                <span class="lg:hidden absolute top-0 left-0 bg-gray-800 px-2 py-1 text-xs font-bold uppercase">Weight</span>
                {{$item ->weight}}
                
            </td>

            <td class="w-full lg:w-auto p-3  text-white text-center border border-b text-center block lg:table-cell relative lg:static">
                <span class="lg:hidden absolute top-0 left-0 bg-gray-800 px-2 py-1 text-xs font-bold uppercase">Height</span>
                {{$item ->height}}
                
            </td>

            <td class="w-full lg:w-auto p-3  text-white text-center border border-b text-center block lg:table-cell relative lg:static">
                <span class="lg:hidden absolute top-0 left-0 bg-gray-800 px-2 py-1 text-xs font-bold uppercase">Action</span>
                
               
                <a href="delete/{{$item->id}}" class=" text-blue-400 hover:text-white "><i class="fas fa-trash"></i></a>
