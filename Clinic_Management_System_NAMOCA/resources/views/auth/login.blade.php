    ...
    <div class="bg-gray-50 w-1/5 h-1/2 mb-5 rounded-lg"> 
      ...
      <p class="text-sm pl-5 text-white mt-6">Clinic Management System</p>
        ...
        <div class="flex flex-col items-center justify-center">
            <input class="hidden w-full bg-gray-50 rounded border border-black-300 pb-4 pt-2 text-center text-black" 
            type="text" name="username" id="username" value="Patient">
            </div>
