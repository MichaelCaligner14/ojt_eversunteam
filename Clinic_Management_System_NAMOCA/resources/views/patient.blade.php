...
<button class="mobile-menu-button p-4 focus:outline-none focus:bg-gray-500">
    ...
    <div class="bg-gray-800 mt-3 mb-5 mr-5 ml-2 w-full rounded-3xl border-white border-solid" style="border:1px solid; border-color:pink;">
        ...
        @if(Session::has('success'))
                <div class="ml-40 text-white bg-gray-600 mt-3 w-80 rounded text-center" role="alert">{{Session::get('success')}}</div>
                @endif

                @if(Session::has('fail'))
                <div class="ml-40 text-red bg-gray-500 mt-3 w-80 rounded text-center" role="alert">{{Session::get('fail')}}</div>
                @endif

        @csrf
        <div class="mt-5">
        <label for="fullname" class="text-white ml-40 ">Fullname </label>
        <input  type="text" name="fullname" value="{{old('fullname')}}" required class="rounded-lg mt-3 bg-gray-800 border-2 ml-40  border-gray-500  "style="width: 68%;">

        <ul class="mt-3">
            <label for="address" class="text-white ml-40">Address </label>
            </ul>
            <input  type="text" name="address" value="{{old('address')}}" required class="rounded-lg  ml-40 mt-3 bg-gray-800 border-2  border-gray-500  " style="width: 68%;">
        ...
        <ul class="mt-3">
            ...
            <input type="text" name="email" value="{{old('email')}}" required placeholder="  @" class="rounded-lg  ml-40 mt-3 bg-gray-800 border-2  border-gray-500  " style="width: 36%;">
            <input type="text" name="contact" value="{{old('contact')}}" required class="rounded-lg mt-3 bg-gray-800 border-2 ml-1  border-gray-500" style="width:31%;">
            ...
            <label for="birth" class="text-white" style="margin-left:34%">Date </label>
                ...
                <input type="text" name="age" value="{{old('age')}}" required  class="rounded-lg  ml-40 mt-3 bg-gray-800 border-2  border-gray-500  " style="width: 36%;">
                <input type="text" name="birth" value="{{old('birth')}}" required class="rounded-lg mt-3 bg-gray-800 border-2 ml-1  border-gray-500" style="width:31%;">
                ...
                <ul class="mt-5">
                    ...
                    <input type="text" name="temp" value="{{old('temp')}}" required placeholder="                                  ℃" class="rounded-lg ml-80 mt-3 bg-gray-800 border-2  border-gray-500  ">
                    <input type="text" name="weight" value="{{old('weight')}}" required placeholder="                                 Kg" class="rounded-lg mt-3 bg-gray-800 border-2  border-gray-500  ">
                    <input type="text" name="height" value="{{old('height')}}" required placeholder="                                 Cm" class="rounded-lg mt-3 bg-gray-800 border-2  border-gray-500  ">

                    <div class="bg-gray-200 ml-24 mt-10" style="width:80%; height: 1px;"></div>
                   
                    <div>
                        <button type="submit" class="bg-gray-600 px-28  text-white mt-7 py-3 rounded-xl hover:bg-gray-700" style="margin-left:38%">SUBMIT</button>
                    </div>
