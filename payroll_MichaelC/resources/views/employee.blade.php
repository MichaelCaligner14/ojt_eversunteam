            ...
            <form class="w-full bg-gray-600 text-white max-w-sm  p-8 mt-6" action="add" method="POST">
              ...
              <div class="flex flex-wrap -mx-3 mb-2">
                ...
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                  ...
                  <div class="relative">
                    <select class="block appearance-none w-full bg-white border border-gray-20e text-black py-2 text-base px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-sex" name="sex">
                      <option>Male</option>
