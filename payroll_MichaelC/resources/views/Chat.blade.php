@extends('layouts.sidebar')
    ...
    margin:10px;
        ...
        <header class="flex  flex-col text-center justify-end shadow">
            ...
            <input type="text" name="username" id="username" class="block w-full text-center bg-gray-700 appearance-none p-2 text-1xl text-lg text-white" value="Administrator">
          </header>
        <div style="height:650px" id="messages" class="block rounded-1xl  overflow-y-auto bg-gradient-to-t from-gray-200 to-gray-100 p-3">
        </div>
            <form id="message_form" class="flex ">
                <input type="text" name="message" id="message_input" class="flex-1 p-2 border text-base" placeholder="Write a message.."/>
  ...
  <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-8.707l-3-3a1 1 0 00-1.414 1.414L10.586 9H7a1 1 0 100 2h3.586l-1.293 1.293a1 1 0 101.414 1.414l3-3a1 1 0 000-1.414z" clip-rule="evenodd" />
    ...
    <div class="hidden lg:block p-12 ">
          ...
          <form action="Chat" method="post">
            @csrf
          <h1 class="font-bold font-mono text-center">Hello! {{$data->username}}</h1>
</form>
