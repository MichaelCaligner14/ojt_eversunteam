          ...
          <nav class="text-center pb-24">
            <a href="employee" class="block py-4 m-3 rounded transition duration-200 justify-center flex hover:bg-blue-400 pl-8">
              ...
              <a href="attendance" class="block py-4 m-3 rounded transition duration-200 justify-center flex hover:bg-blue-400 pl-10">
                ...
                <a href="records" class="block py-4 m-3 rounded transition duration-200 justify-center flex hover:bg-blue-400 pl-3">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1H8a3 3 0 00-3 3v1.5a1.5 1.5 0 01-3 0V6z" clip-rule="evenodd" />
                    <path d="M6 12a2 2 0 012-2h8a2 2 0 012 2v2a2 2 0 01-2 2H2h2a2 2 0 002-2v-2z" />
                  </svg><span class="px-6">RECORDS</span></a>

             <a href="salary" class="block py-4 m-3 rounded transition duration-200 justify-center flex hover:bg-blue-400">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
