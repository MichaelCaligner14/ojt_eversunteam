...
<body>
    <div class="relative min-h-screen md:flex">
        ...
        <div class="flex-1 p-10 text-2xl font-bold">
            ...
            <p class="w-80 h-12 text-2xl font-bold">EMPLOYEES ATTENDANCE</p>
            <div class="bg-gray-300" style="width: full; height: 5px;">

        <div class="grid md:grid-flow-col gap-4 ">
        <div class="grid grid-cols-1 gap-4">
          <div>
            <div class="py-12"><img class="w-96 h-full mx-auto" src="img/pic1.png"/></div>
          </div>
        </div>
        <div class="grid grid-cols-1 mx-auto">
          <div>
            <form class="w-full bg-gray-600 text-white max-w-sm  p-8 mt-6">
              ...
              <div class="flex flex-wrap -mx-3 mb-4">
                <div class="w-full px-3">
                  <label class="block uppercase tracking-wide text-xs font-bold mb-2" for="grid-hours">
                    Hours Rendered
                  </label>
                  <input class="appearance-none block w-full bg-white text-black border 
                  border-red-500 rounded text-base py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-password" type="number">
                </div>
              </div>
        ...
        <div class="grid grid-cols-1 py-20 mx-auto md:grid-cols-3">
          <div class="py-20">
