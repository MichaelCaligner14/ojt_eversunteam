...
<body>
    ...
    <img src="./logo.png"/>
        ...
        @csrf
        <p class="text-6xl flex-col w-23 h-20 text-black font-bold font-roboto">Student Form</p>
        <br>
          <p class="text-lg font-serif  mb-2 mt-2">First Name</p>
                <input class="w-full px-3 py-3 border border-gray-400" type="text" placeholder="Enter Firstname" name="first" value="{{old('first')}}">
                <span class="text-red-800 text-sm">@error('first') {{$message}} @enderror </span>
                <p class="text-lg font-serif  mb-2 mt-2">Middle Name</p>
                <input class="w-full px-3 py-3 border border-gray-400" type="text" placeholder="Enter Middlename" name="middle" value="{{old('middle')}}">
                <span class="text-red-800 text-sm">@error('middle') {{$message}} @enderror </span>
                <p class="text-lg font-serif  mb-2 mt-2">Last Name</p>
                <input class="w-full px-3 py-3 border border-gray-400" type="text" placeholder="Enter Lastname" name="last" value="{{old('last')}}">
