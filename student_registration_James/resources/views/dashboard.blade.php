...
<body class="bg-gray-100">
    ...
    <img src="./logo.png"/>
          ...
          <nav>
            ...
            <a href="{{ url('homepage') }}" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white "> 
        ...
        <table class="border-collapse w-full">
          ...
          <tbody>
             ...
             <a class="btns btns-blue btns-blue:hover px-10" href="homepage">DONE</a>
      </div>
