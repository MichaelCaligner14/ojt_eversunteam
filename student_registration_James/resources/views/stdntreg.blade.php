...
@section('content')
        ...
        <form action="addingstud" method="post" class="bg-gray-900 border-2 border-gray-800 font-bold px-6 py-6 rounded-md">

        @csrf
        <p class="text-6xl text-white pb-3 font-bold font-roboto">Student Form</p>
        ...
        <p class="text-xs w-23 h-12 text-red-800 font-bold font-roboto">Please fill up the form properly:</p>
                ...
                <p class="text-lg font-roboto text-white mb-2 mt-2">First Name</p>
                ...
                <p class="text-lg font-roboto text-white mb-2 mt-2">Middle Name</p>
                ...
                <p class="text-lg font-roboto text-white mb-2 mt-2">Last Name</p>
                ...
                <p class="text-lg font-roboto text-white mb-2 mt-2">Birthday</p>
                <input class="w-1/8 px-3 py-1 border border-gray-800 rounded-md" type="date" placeholder="Enter Birthday" name="birthday" value="{{old('birthday')}}">
                <br>
                <span class="text-red-800 text-sm ">@error('birthday') {{$message}} @enderror </span>
               
                <p class="text-lg font-roboto text-white mb-2 mt-2">Address</p>
                ...
                <p class="text-lg font-roboto text-white mb-2 mt-2">Gender</p>
                ...
                <p class="text-lg font-roboto text-white mb-2 mt-2">Course List</p>
                ...
                <p class="text-lg font-roboto text-white mb-2 mt-2">Mobile Number</p>
                ...
                <p class="text-lg font-roboto text-white mb-2 mt-2">Enter Parents/Guardian Name</p>
                ...
                <p class="text-lg font-roboto text-white mb-2 mt-2">Enter Parents/Guardian Mobile Number</p>
