    ...
    <img src="./logo.png"/>
        ...
        <div class="max-w-2xl absolute form mx-24 m-auto w-full mt-10 w-2/6" style="transform:translate(-50%, -50%); left:50%; top:50%;">
            ...
            <p class="text-lg font-serif  mb-2 mt-2">First Name</p>
                <input class="w-full px-3 py-3 border border-gray-400" type="text" placeholder="Enter Firstname">
            <p class="text-lg font-serif  mb-2 mt-2">Middle Name</p>
                <input class="w-full px-3 py-3 border border-gray-400" type="text" placeholder="Enter Middle Name">
                <p class="text-lg font-serif  mb-2 mt-2">Last Name</p>
                <input class="w-full px-3 py-3 border border-gray-400" type="text" placeholder="Enter Lastname">
                <p class="text-lg font-serif  mb-2 mt-2">Birthday</p>
                <input class="w-full px-3 py-3 border border-gray-400" type="text" placeholder="Enter Birthday">
                <p class="text-lg font-serif  mb-2 mt-2">Address</p>
                <input class="w-full px-3 py-3 border border-gray-400" type="text" placeholder="Enter Address">
