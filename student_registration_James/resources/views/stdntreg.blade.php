...
<body>
    ...
    <img src="./logo.png"/>
          ...
          <nav>
            ...
            <a href="home" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white "> 
        ...
        <form action="addingstud" method="post" >

        @csrf
        <p class="text-6xl flex-col w-23 h-20 text-gray-800 font-bold font-roboto">Student Form</p>
        <p>________________________________________________________________________________________________</p>
        <p class="text-xs flex-col w-23 h-12 text-red-800 font-bold font-roboto">Please fill up the form properly:</p>
        
                <p class="text-md font-roboto mb-2 mt-2">First Name</p>
                <input class="w-3/5 px-3 py-1 border border-gray-400" type="text" placeholder="Enter First Name" name="first" value="{{old('first')}}">
                <br>
                <span class="text-red-800 text-sm">@error('first') {{$message}} @enderror </span>
               
                <p class="text-md font-roboto  mb-2 mt-2">Middle Name</p>
                <input class="w-3/5 px-3 py-1 border border-gray-400" type="text" placeholder="Enter Middlename" name="middle" value="{{old('middle')}}">
                <br>
                <span class="text-red-800 text-sm">@error('middle') {{$message}} @enderror </span>
                
                <p class="text-md font-roboto  mb-2 mt-2">Last Name</p>
                <input class="w-3/5 px-3 py-1 border border-gray-400" type="text" placeholder="Enter Lastname" name="last" value="{{old('last')}}">
                <br>
                <span class="text-red-800 text-sm ">@error('last') {{$message}} @enderror </span>
                
                <p class="text-md font-roboto  mb-2 mt-2">Birthday</p>
                <input class="w-3/5 px-3 py-1 border border-gray-400" type="text" placeholder="Enter Birthday" name="birthday" value="{{old('birthday')}}">
                <br>
                <span class="text-red-800 text-sm ">@error('birthday') {{$message}} @enderror </span>
               
                <p class="text-md font-roboto  mb-2 mt-2">Address</p>
                <input class="w-3/5 px-3 py-1 border border-gray-400" type="text" placeholder="Enter Address" name="address" value="{{old('address')}}">
                <br>
                <span class="text-red-800 text-sm ">@error('address') {{$message}} @enderror </span>
                
                <p class="text-md font-roboto  mb-2 mt-2">Gender</p>
  
                           
                            <select class="form-control w-34 mt-2 mb-2 px-4 lg:py-2 xs:py-1 sm:py-1 border rounded-md
                            text-gray-600 focus:outline-none focus:border-green-500" id="" name="gender" value="{{old('gender')}}">
                ...
                <p class="text-md font-roboto  mb-2 mt-2">Course List</p>
                
                <select class="form-control w-3/5 mt-2 mb-2 px-4 lg:py-2 xs:py-1 sm:py-1 border rounded-md
                            text-gray-600 focus:outline-none focus:border-green-500" id="" name="courselist" value="{{old('courselist')}}">
                ...
                <p class="text-md font-roboto  mb-2 mt-2">Mobile Number</p>
                <input class="w-3/5 px-3 py-1 border border-gray-400" type="text" placeholder="Enter Mobile Number" name="mobilenumber" value="{{old('mobilenumber')}}">
                <br>
                <span class="text-red-800 text-sm ">@error('mobilenumber') {{$message}} @enderror </span>
                
                <p class="text-md font-roboto  mb-2 mt-2">Enter Parents/Guardian Name</p>
                <input class="w-3/5 px-3 py-1 border border-gray-400" type="text" placeholder="Enter Parents/Guardian Name" name="parentsguardianname" value="{{old('parentsguardianname')}}">
                <br>
                <span class="text-red-800 text-sm ">@error('parentsguardianname') {{$message}} @enderror </span>
                
                <p class="text-md font-roboto  mb-2 mt-2">Enter Parents/Guardian Mobile Number</p>
                <input class="w-3/5 px-3 py-1 border border-gray-400" type="text" placeholder="Enter Parents/Guardian Mobile Number" name="parentsguardiannumber" value="{{old('parentsguardiannumber')}}">
                <br>
                ...
                <br>
                <button type="submit"
               class="py-1 px-2 bg-primarycolor rounded-2 text-white font-bold uppercase hover:bg-blue-500 text-lg mt-4 transform bg-gray-600 transition-all duration-500 bg-black bg-opacity-90 rounded" style="width: 90px; height: 58px;"
               >FINISH</button>
