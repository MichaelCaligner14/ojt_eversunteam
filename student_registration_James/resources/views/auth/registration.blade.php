    ...
    >
      ...
      <div class="bg-gray-800 rounded-lg" style="width: 400px; height: 600px; float: right: 150px;">
        ...
        <button type ="submit"
          ...
          <a href="login"
          class="py-2 px-4 bg-primarycolor rounded-5 text-white font-bold uppercase text-lg mt-4 transform bg-black-600 transition-all duration-500 bg-black bg-opacity-90 rounded" style="width: 150px; height: 40px;"
          >Login Here!</a> 
