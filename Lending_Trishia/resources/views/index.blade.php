...
<body>  
    ...
    <div class="bg-primarycolor flex justify-between  items-center lg:p-3 xs:p-4 sm:p-3 md:p-3">
        ...
        <div class="hidden md:flex   justify-end items items-center lg:inline-flex lg:flex-row lg:w-auto" id="navigation">
            <a href="login" class="inline-block mr-4 p-3 text-white hover:bg-gray-900 rounded-lg font-bold">LOGIN</a>
            <a href="registration" class="inline-block p-3 lg:mr-12 xs:mr-2 text-white hover:bg-gray-900 rounded-lg font-bold">SIGN UP</a>
        </div>
