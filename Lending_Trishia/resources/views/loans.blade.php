    ...
    <div class="relative min-h-screen md:flex">
        ...
        <div class="flex-1  w-full items-center justify-center">
            ...
            <div class="bg-white lg:w-3/4 mx-auto lg:px-16 xs:px-6 sm:px-6 md:px-10 shadow-xl">
                <h1 class="font-fourth text-center font-bold text-2xl pt-6">New Loan Application</h1>
                <hr class="-mx-18 mt-2">
                <div class="py-6">
                    ...
                    <div class=" w-full px-1 mt-0">
                        ...
                        <input type="text" placeholder="" name="haddress" class="w-full mt-2 mb-2 px-4 lg:py-2 xs:py-1 sm:py-1 border rounded-md
                        text-gray-600 focus:outline-none focus:border-green-500"/>
                    </div>
                    ...
                    <div class="flex">
                        ...
                        <div class=" w-1/2 px-1 mt-0">
                            ...
                            <input type="text" placeholder="" name="cnum" class="w-full mt-2 mb-2 px-4 lg:py-2 xs:py-1 sm:py-1 border rounded-md
                            text-gray-600 focus:outline-none focus:border-green-500"/>
                        </div>
                    </div>
                ...
                <div class="py-6">
                    ...
                    <div class="flex">
                        <div class=" w-1/2 px-1 mt-0">
                            ...
                            <input type="text" placeholder="" name="loanType" class="w-full mt-2 mb-2 px-4 lg:py-2 xs:py-1 sm:py-1 border rounded-md
                            text-gray-600 focus:outline-none focus:border-green-500"/>
                        </div>
                        ...
                        <div class=" w-1/2 px-1 mt-0">
                            ...
                            <input type="text" placeholder="" name="loanAmount" class="w-full mt-2 mb-2 px-4 lg:py-2 xs:py-1 sm:py-1 border rounded-md
                            text-gray-600 focus:outline-none focus:border-green-500"/>
                        </div>
                    </div>
                    <div class="flex">
                        <div class=" w-1/2 px-1 mt-0">
                            ...
                            <input type="text" placeholder=" " name="loanMonths" class="w-full mt-2 mb-2 px-4 lg:py-2 xs:py-1 sm:py-1 border rounded-md text-gray-600 focus:outline-none focus:border-green-500"/>
                        </div>
                        <div class=" w-1/2 px-1 mt-0">
                            <label class="text-gray-600 font-light ">Interest</label>
                            <input type="text" placeholder="" name="loanInterest" class="w-full mt-2 mb-2 px-4 lg:py-2 xs:py-1 sm:py-1 border rounded-md
                            text-gray-600 focus:outline-none focus:border-green-500"/>
                        </div>
                    </div>
                    <div class="flex justify-between">
                        ...
                        <div class=" lg:w-1/4 xs:w-1/4 sm:w-1/4 md:W-1/4 px-2 mt-0">
                            <button type="submit" class="w-full  mt-8 mb-2 px-4 lg:py-2 xs:py-1 sm:py-1 border rounded-md bg-blue-800 text-white font-bold focus:outline-none focus:border-green-500">COMPUTE</button>
                        </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="w-3/4 mx-auto py-6 flex justify-end">
                ...
                <button type="submit" class="py-1 px-12 bg-gray-800  rounded-md text-center  text-white font-bold uppercase text-lg">CANCEL</button>
            </div>
            </div></div>
    </div>
    </div>
