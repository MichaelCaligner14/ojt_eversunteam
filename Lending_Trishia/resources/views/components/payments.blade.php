            ...
            <div class="modal-content py-4 text-left px-6">
                ...
                @csrf
                    ...
                    <div class="flex items-center mb-2">
                        ...
                        <input type="text" placeholder="" id="loanref_id" name="loanref_id" class="w-full mt-2 mb-2 px-4 lg:py-2 xs:py-1 md:py-1 sm:py-1 border rounded-md
                ...
                @foreach($list as $item)
                    ...
                    <td class="w-full lg:w-auto p-1.5 text-gray-800 text-center border text-sm border-b block lg:table-cell  lg:static">
                        ...
                        <td class="w-full lg:w-auto p-1.5 text-gray-800  border border-b text-sm text-center lg:table-cell  lg:static">
                            ...
                            <a href="deletePay/{{$item->id}}" class="text-blue-400 hover:text-blue-600 underline"><svg xmlns="http://www.w3.org/2000/svg" 
