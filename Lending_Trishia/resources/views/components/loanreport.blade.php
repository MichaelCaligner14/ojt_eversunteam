...
@section('content')   
    ...
    @stop
            ...
            <div class="p-8">
                <h1 class="font-fourth font-bold text-3xl tracking-widest">LOAN REPORT</h1>
            ...
            <table class="border-collapse w-full shadow-md">
                <thead>
                    <tr>
                        ...
                        <th class="p-3 font-bold text-xs uppercase bg-gray-700 text-white border border-gray-300 hidden lg:table-cell">Borrower ID</th>
