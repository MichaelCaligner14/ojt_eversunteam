...
<body class="bg-gray-100">
    ...
    <div class="relative min-h-screen md:flex">
        ...
        <div class="flex-1  w-full">
            ...
            <div class="p-8">
                <h1 class="font-fourth font-bold text-3xl tracking-widest">USERS</h1>
                
                <div class="inline-block mt-8">
                    <input type="text" placeholder="" 
                    class="lg:w-full sm:w-full inline-block shadow-md mt-2 mb-2 px-4 py-1 border rounded-md text-gray-600 focus:outline-none focus:border-green-500"/>
                </div>
