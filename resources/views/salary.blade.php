...
<body>
    <div class="relative min-h-screen md:flex">
        ...
        transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out h-full">
        ...
        <div class="flex-1 p-10 text-2xl font-bold">
            ...
            <p class="w-80 h-12 text-2xl font-bold">EMPLOYEES SALARY</p>
