         ...
         <!-- nav -->
          <nav class="text-center pb-24">
            <a href="{ url('employee') }}" class="block py-4 m-3 rounded transition duration-200 justify-center flex hover:bg-blue-400 pl-8">
              ...
              <a href="{{ url('attendance') }}" class="block py-4 m-3 rounded transition duration-200 justify-center flex hover:bg-blue-400 pl-10">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  <path d="M8 9a3 3 0 100-6 3 3 0 000 6zM8 11a6 6 0 016 6H2a6 6 0 016-6zM16 7a1 1 0 10-2 0v1h-1a1 1 0 100 2h1v1a1 1 0 102 0v-1h1a1 1 0 100-2h-1V7z" />
                </svg><span class="px-6">ATTENDANCE</span></a>
          
          
                <a href="{{ url('records') }}" class="block py-4 m-3 rounded transition duration-200 justify-center flex hover:bg-blue-400 pl-3">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1H8a3 3 0 00-3 3v1.5a1.5 1.5 0 01-3 0V6z" clip-rule="evenodd" />
                    <path d="M6 12a2 2 0 012-2h8a2 2 0 012 2v2a2 2 0 01-2 2H2h2a2 2 0 002-2v-2z" />
                  </svg><span class="px-6">RECORDS</span></a>

             <a href="{{ url('salary') }}" class="block py-4 m-3 rounded transition duration-200 justify-center flex hover:bg-blue-400">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              ...
              <a href="logout" class="block py-4 m-3 rounded transition duration-200 justify-center flex hover:bg-blue-400">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <form class="w-full bg-gray-600 text-white max-w-sm  p-8 mt-6">
              ...
              <div class="flex flex-wrap -mx-3 mb-2">
                ...
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                  ...
                  <div class="relative">
                    <select class="block appearance-none w-full bg-white border border-gray-20e text-black py-2 text-base px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-sex">
                      <option>Male</option>
              ...
              <table class="w-full text-base">
                ...
                <tbody class="bg-white">
                   ...
                   <tr class="text-gray-700">
                    ...
                    <td class="px-4 py-3 border">M</td>
                    <td class="px-4 py-3 border">Davao City</td>
                    <td class="px-4 py-3 border">
                      ...
                      </svg><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 fill-current text-red-400 float-left" viewBox="0 0 20 20" fill="currentColor">
