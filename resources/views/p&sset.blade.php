...
<body class="bg-light-gray grid grid-cols-4 lg:grid-cols-7 gap-x-10 pr-10 grid-rows-5">
    ...
    <div class="col-span-5 ml-10 md:ml-0 md:col-start-2 md:col-end-5 md:col-span-3 lg:col-start-2 lg:col-end-8 lg:col-span-6 row-start-2 row-end-6 lg:row-start-2 lg:row-end-6 -mt-20 mb-10 lg:-mt-20 grid grid-cols-4 lg:grid-cols-8 grid-rows-9 md:text-xl font-condensed">
        ...
        <div class="row-start-8 col-span-4 lg:col-span-8 col-start-3 -ml-32 md:-ml-40 lg:col-start-5">
