  ...
  <div class="sidebar bg-shark-500 text-blue-100 w-64 space-y-40 py-7 px-2 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out>">
      <a href="#" class="px-6">
        ...
        <div class="flex-1 p-10  font-bold">
            <p class="text-4xl flex justify-between p-2">--INVENTORIES--
            <a href="logout">
            ...
            <div class="bg-white lg:w-3/4 mx-auto lg:px-16 xs:px-6 sm:px-6 md:px-10 pt-16">

              <div action="" method="post" class="flex">
                @csrf
                  <div class="w-60 px-1">
                      <label class="text-gray-600">CODE</label>
                      <input type="text" placeholder="" class="w-full mt-2 mb-2 px-4 py-2 border border-black-900 rounded-md
                      text-gray-600 "/>
                  </div>
                  <div class="w-60 px-1">
                      <label class="text-gray-600">P-CODE</label>
                      <input type="text" placeholder="" class="w-full mt-2 mb-2 px-4 py-2 border border-black-900 rounded-md
                      text-gray-700 "/>
                  </div>
                  <div class="w-60 px-1">
                      <label class="text-gray-600 ">QUANTITY</label>
                      <input type="text" placeholder="" class="w-full mt-2 mb-2 px-2 py-2 border border-black-900 rounded-md
                      text-gray-700 "/>
                  </div>
             ...
             <table class=" shadow-md border-collapse w-full">
              <thead>
                  <tr>
                      ...
                      <th class="p-3 font-bold text-sm uppercase bg-shark-500 text-white border border-gray-300 hidden lg:table-cell">Product Code</th>
