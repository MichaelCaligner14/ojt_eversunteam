...
@section('content')
        ...
        <!--<div class="lg:w-3/4 mx-auto lg:px-16 xs:px-6 sm:px-6 md:px-10 pt-16">

            @include('layouts.flash')
                <form action="addinventory" method="post" 
                class="text-gray-600 font-bold rounded px-8 pb-8 mb-4">
                @csrf
                  <div class="flex">
                  <div class="w-60 px-1">
...
<form action="addinventory" method="post" class="min-h-3/6 flex items-center justify-center">
         @csrf
      ...
      <div class="bg-white rounded p-4 px-4 md:p-8 mb-6">
        <div class="grid  gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
          <div class="text-gray-600 pr-8">
            ...
            <p class="font-medium text-lg">Inventory Details</p>
          ...
          <div class="lg:col-span-2">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              <div class="md:col-span-5">
                ...
                <input type="text" name="product_name" id="product_name" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{old('product_name')}}" />
              </div>
              <span class="text-red-800">@error('product_name') {{$message}} @enderror </span>
              ...
              <div class="md:col-span-5">
                ...
                <input type="text" name="Inventory_quantity" id="Inventory_quantity" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{old('Inventory_quantity')}}" />
              </div>
              <span class="text-red-800">@error('Inventory_quantity') {{$message}} @enderror </span>
