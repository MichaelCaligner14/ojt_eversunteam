  ...
  <header class="bg-casal-500 p-2 font-medium text-left text-white">
    Inventory System
        ...
        <div class="flex-1 p-10  font-bold">
            ...
            <div class="flex bg-white sm:px-6 md:px-10 pt-16 justify-center items-center">
            ...
            @csrf
                ...
                <form action="{{ route('produpdate') }}" method="post" class="min-h-3/6  mt-8 items-center justify-center">
         @csrf
          ...
          <input type="hidden" placeholder="" name="prodname" value="{{ $Info->id }}" class="w-full mt-2 mb-2 px-4 py-2 border border-black-900 rounded-md
            ...
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <div class="md:col-span-5">
                ...
                <input type="text" name="price" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ $Info->items }}" />
              </div>
