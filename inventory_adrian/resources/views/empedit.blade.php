  ...
  <header class="bg-casal-500 p-2 font-medium text-left text-white">
    Inventory System
        ...
        <div class="flex-1 p-10  font-bold">
            <p class="text-4xl flex justify-between p-2">--EMPLOYEES UPDATE--
            <a href="logout">
            ...
            @csrf
                        ...
                        <input type="hidden" placeholder="" name="empid" value="{{ $item->id }}" class="w-full mt-2 mb-2 px-4 py-2 border border-black-900 rounded-md
                          ...
                          <div class="w-96 px-1">
                              ...
                              <input type="text" placeholder="" name="prodname" value="{{ $item->prodname }}" id="name" class="w-full mt-2 mb-2 px-4 py-2 border border-black-900 rounded-md
                              text-gray-700 "/>
