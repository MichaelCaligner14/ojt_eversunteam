  ...
  <div class="w-full min-h-screen flex justify-center items-center lg:grid lg:grid-cols-2 p-6 text-white">
      ...
      <form class=" bg-casal-500 flex flex-col items-center lg:w-full md:w-2/3 h-full p-6 xs:w-full sm:w-2/3 pt-56 pb-56"></h2>
              ...
              <div class="relative mt-4 w-60">
                ...
                <input type="" placeholder="Confirm password" class="w-full h-10 border border-gray-200 p-3 text-black text-sm rounded outline-none focus:border-blue-400"/>
            </div>
              <a href="{{ url('index') }}" class="py-3 px-8 bg-black-900 rounded-lg text-center text-white font-bold uppercase tex-lg mt-4 w-30">Create Account</a>
          </form>
