...
@section('content')
        ...
        <script src="script.js"></script>
            ...
            <div class="bg-white lg:w-3/4 mx-auto lg:px-16 xs:px-6 sm:px-6 md:px-10 pt-16 justify-start">
                <div class="p-10 font-bold justify-center lg:px-16 xs:px-6 sm:px-6 md:px-10">

                
                @include('layouts.flash')
                
                  <div class="w-full float-left xs:w-full lg:px-16 xs:px-6 sm:px-6 md:px-10 gap-2">  
