  ...
  <div class="sidebar bg-shark-500 text-blue-100 w-64 space-y-40 py-7 px-2 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out>">
      <a href="#" class="px-6">
        ...
        <div class="flex-1 p-10  font-bold">
            <p class="text-4xl flex justify-between p-2">--PRODUCTS--
            <a href="logout">
            ...
            <div class="bg-black-900 pt-1" style="width: full; height: 5px;">
            </div>
            ...
            @if (Session::has('success'))
                ...
                <form action="addprod" method="post" class="flex">
                @csrf
              ...
              <div class="flex">
                  ...
                  <div class=" lg:w-24 xs:w-24 sm:w-24 md:w-24 px-2 mt-0">
                    <button class="w-60 mt-8 mb-2 px-4 py-2 border rounded-md bg-blaze-orange-500 text-white font-bold ">ADD</button>
                </div>
                </form>
              </div>
              <br>
                ...
                @foreach ($list as $item)
                    <tr class="bg-hint-of-green-500 lg: flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                      ...
                      <td class="w-full lg:w-auto p-1.5 text-gray-800  border border-b text-sm text-center lg:table-cell  lg:static">
                          ...
                          <button id="buttonmodal" class="text-blue-400 hover:text-blue-600 underline pl-6"><svg xmlns="http://www.w3.org/2000/svg" 
          ...
          <div id="modal" class="fixed top-0 left-0 w-screen h-screen flex items-center justify-center bg-black-400 bg-opacity-50 transform scale-0 transition-transform duration-300">
    <!-- Modal content -->
...
<script src="orderdeletemodal.js"></script>
