    ...
    Inventory System
        ...
        <div class="flex-1 p-10  font-bold">
            ...
            <div class="bg-gray-200  py-2 px-3 rounded shadow-xl text-gray-800">
                ...
                <form action="{{ route('inventoryupdate') }}" method="post" class="m-8 justify-center items-center">
            @csrf
                        ...
                        <input type="hidden" placeholder="" name="ivtname" value="{{ $Info->id }}" class="w-full mt-2 mb-2 px-4 py-2 border border-black-900 rounded-md
                          ...
                          <div class="w-96 px-1">
                              ...
                              <input type="text" placeholder="" name="product_name" value="{{ $Info->product_name }}" id="name" class="w-full mt-2 mb-2 px-4 py-2 border border-black-900 rounded-md
                              text-gray-700 "/>
                          ...
                          <div class="w-96 px-1">
                              ...
                              <input type="text" placeholder="" name="items" value="{{ $Info->items }}" id="order" class="w-full mt-2 mb-2 px-2 py-2 border border-black-900 rounded-md
                              text-gray-700 "/>
