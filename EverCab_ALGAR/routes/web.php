...
Route::get('/reservationedit', [CustomAuthController::class, 'reservationlist'])->middleware('isLoggedIn');

Route::get('/reservationadd', [CustomAuthController::class, 'reservationlist'])->middleware('isLoggedIn');
