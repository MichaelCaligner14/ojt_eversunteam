...
Route::middleware('auth:sanctum')->get('/chat/rooms', [EverChatController::class, 'rooms']);

Route::middleware('auth:sanctum')->get('/chat/room/{roomId}/messages', [EverChatController::class, 'messages']);

Route::middleware('auth:sanctum')->post('/chat/room/{roomId}/message', [EverChatController::class, 'newMessage']);