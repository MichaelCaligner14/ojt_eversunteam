...
<body class="bg-light-gray grid grid-cols-4 lg:grid-cols-7 gap-10 pr-10 grid-rows-5">
    ...
    <form method="post" action="{{route('reservationlist')}}" class="bg-baby-blue ml-20 col-span-4 row-span-3 -mb-1 md:col-start-3 md:col-span-3 lg:col-start-4 lg:col-span-2 row-start-2 md:row-start-2 md:row-span-2 text-2xl p-5 shadow-xl rounded-md md:-mb-10 md:ml-0 md:mr-28 lg:mr-32">
        @csrf
        Date: <input type="text" name="date" class="block border mt-2">
        Pickup Location: <input type="text" name="pickup" class="block border mt-2">
        Destination: <input type="text" name="destination" class="block border mt-2">
        Pickup Time: <input type="text" name="time" class="block border mt-2">
