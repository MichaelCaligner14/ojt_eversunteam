...
<body class="bg-light-gray grid grid-cols-4 grid-rows-5 lg:grid-cols-7 gap-10 pr-10">
    ...
    <div class="md:col-start-3 col-start-2 col-span-2 md:col-span-1 lg:col-start-4 lg:col-end-6 row-start-2 row-span-3 bg-baby-blue rounded-2xl shadow-xl -ml-20 -mr-20 lg:ml-10 lg:mr-10 pt-10 pl-16">
