...
<body class="bg-light-gray grid grid-cols-4 lg:grid-cols-7 gap-10 pr-10 grid-rows-5">
    ...
    <form action="" class="bg-white col-start-4 col-span-2 row-start-2 row-span-2 text-2xl p-5 shadow-xl rounded-md -mb-10 mr-24">
        Date: <input type="text" class="block border mt-2">
        Pickup Location: <input type="text" class="block border mt-2">
        Destination: <input type="text" class="block border mt-2">
        Pickup Time: <input type="text" class="block border mt-2">
        <button type="submit" class="btntest mt-5">
            Submit Reservation
        </button>
