...
<body class="bg-baby-blue grid grid-cols-5 md:grid-cols-3 lg:grid-cols-5 grid-rows-6 lg:grid-rows-6">
    <form class="bg-white col-start-2 col-span-3 md:col-start-2 md:col-span-1 lg:col-start-3 lg:col-span-1 row-start-2 lg:row-start-2 row-span-3 md:row-span-3 lg::row-span-3 lg:row-span-2 border pt-6">
        <span class="underline font-bold text-4xl pl-24 lg:pl-32 font-condensed">EverCab</span>
        <input type="number text email" placeholder="Phone number, username, or email" class="text-sm w-64 bg-light-gray border ml-6 mt-8 lg:ml-14 p-2 rounded">
        <input type="password" placeholder="Password" class="text-sm w-64 bg-light-gray border ml-6 mt-2 lg:ml-14 p-2 rounded">
