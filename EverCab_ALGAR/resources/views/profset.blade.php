...
<body class="bg-light-gray grid md:grid-cols-4 lg:grid-cols-7 gap-x-10 pr-10 grid-rows-5">
    ...
    <div class="col-start-2 col-end-5 col-span-3 lg:col-start-2 lg:col-end-8 lg:col-span-6 row-start-2 row-end-6 lg:row-start-2 lg:row-end-6 -mt-20 mb-10 lg:-mt-20 grid grid-cols-4 lg:grid-cols-8 grid-rows-12 md:grid-rows-7 md:text-xl font-condensed">
